 ...
 * features are defined as part of the SDL_app functions. But on Android 
 * they require us to add a few new methods to the activity. That is the 
...
public class APPActivity extends SDLActivity {
    ...
    /**
     * Executes upon activity creation
     *
    ...
    /**
     * Executes when we need to cleanly pause the native thread
     */
    @Override
    ...
    /**
     * Executes when we need to resume the native thread
     */
    @Override
