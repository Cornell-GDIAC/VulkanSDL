/**
 * Vulkan Tutorial: Part 2
 *
 * This code is vertex buffer tutorial from https://vulkan-tutorial.com.
 * It is the material up to and including the section on the index buffer.
...
public:
    ...
    bool setup() {
        ...
        if (!SDL_SetAppMetadata("Hello Triangle", "1.0.0","com.vulkan-tutorial.tutorial2")) {
