/**
 * Vulkan Tutorial: Part 7
 *
 * This code is the multisampling tutorial from https://vulkan-tutorial.com.
...
public:
    ...
    bool setup() {
        ...
        if (!SDL_SetAppMetadata("Vulkan Tutorial", "1.0.0","com.vulkan-tutorial.tutorial8")) {
