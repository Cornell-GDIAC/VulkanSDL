...
on [swap chain recreation](https://vulkan-tutorial.com/Drawing_a_triangle/Swap_chain_recreation). However, it has been updated to use dynamic rendering.
That means there is no more need for explicit framebuffers. Note that this
is only supported on Vulkan 1.3 or higher.
