/**
 * Vulkan Tutorial: Part 5
 *
 * This code is the depth buffering tutorial from https://vulkan-tutorial.com.
...
public:
    ...
    bool setup() {
        ...
        if (!SDL_SetAppMetadata("Vulkan Tutorial", "1.0.0","com.vulkan-tutorial.tutorial5")) {
