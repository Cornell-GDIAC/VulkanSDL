...
top of a background color. By default this background color is white, but it can 
be specified with a custom attribute.
...
attribute will apply rounded corners on the desktop icons. Both this value and 
