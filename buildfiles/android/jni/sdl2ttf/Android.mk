...
SDL2_TTF_PATH    := $(LOCAL_PATH)/$(CURR_DEPTH)/$(TTF_OFFSET)
SDL2_TTF_SOURCE  := $(SDL2_TTF_PATH)
SDL2_TTF_INCLUDE := $(SDL2_TTF_PATH)
...
LOCAL_C_INCLUDES += $(SDL2_TTF_INCLUDE)
